...
import 'package:demo/presentation/signup/update_learning_data/update_learning_data_screen.dart';
  ...
  routes: [
    ...
    ShellRoute(
      builder: (context, state, child) {
        return BlocProvider(create: (_) => getIt<SignupCubit>(), child: child);
      },
      routes: [
        GoRoute(
